;(function(){
    ...
    var defaults = {
        ...
        facetContainer     : '<div class="col facetsearch" id=<%= id %> ></div>',
        ...
        noResults          : '<div class=results>Sorry, but no artist match these criteria</div>',
    ...
    function updateResults() {
        finalData = settings.currentResults;
        nbMaj++;
        refreshData();
        setStatus("Donnée mise à jour("+nbMaj+")");
    }
})();
